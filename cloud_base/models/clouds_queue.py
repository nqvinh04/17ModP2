...
class clouds_queue(models.Model):
    ...
    next_attempt = fields.Datetime(string="Not eralier than", default=lambda self: fields.Datetime.now(), index=True)
    ...
    def _get_next_snapshots(self, processed_ids=[]):
        ...
        return self.env["clouds.snapshot"].search(
            [("id", "not in", processed_ids), ("reverse_state", "!=", "rearranged"), ("move_state", "=", "normal")],
    ...
    def _reapply_blockings(self):
        ...
        assume_done_snapshots = self.env["clouds.snapshot"].search([
            ...
            "|",
                ("parent_id", "=", False),
                "&",
                    ("parent_id.reverse_state", "=", "normal"), ("parent_id.move_state", "=", "normal"),
        ])
    ...
    def _is_task_blocked(self):
        ...
        if self._is_any_parent_blocking():
            return True
