...
export class WhatsappComposer extends Component {
    ...
    static template = "whatsapp.Composer";
    ...
    get placeholder() {
        ...
        if (this.thread) {
            if (this.thread.type === "channel") {
                return _t("Whatsapp #%(thread name)s…", { "thread name": this.thread.displayName });
            }
            return _t("Type a message");
        }
        return "";
    }
    ...
    dragDropText (ev) {
        ...
        // this.props.composer.message = data;
        this.props.composer.textInputContent = data;
        this.ref.el.focus();
    }
    ...
    async sendMessage() {
        await this.processMessage(async (value) => {
            ...
            console.log("______________attachment_____________", postData);
