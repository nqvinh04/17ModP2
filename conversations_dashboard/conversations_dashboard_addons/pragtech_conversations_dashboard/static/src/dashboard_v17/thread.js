...
import { WhatsappMessage } from "@pragtech_conversations_dashboard/dashboard_v17/whatsapp_message";
import {
    useAutoScroll,
    useScrollPosition,
    useScrollSnapshot,
 ...
 */
export class WhatsappThread extends Component {
    static components = { WhatsappMessage, Transition, DateSection };
    static props = [
        "showDates?",
        "isInChatWindow?",
        "jumpPresent?",
    ...
    static template = "whatsapp.Thread";
