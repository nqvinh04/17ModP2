...
export class ThreadViewTopbarDashboard extends Component {
...
Object.assign(ThreadViewTopbarDashboard, {
    props: {
        localId: String,
    },
    template: 'mail.ThreadViewTopbarDashboard',
});

registerMessagingComponent(ThreadViewTopbarDashboard);
