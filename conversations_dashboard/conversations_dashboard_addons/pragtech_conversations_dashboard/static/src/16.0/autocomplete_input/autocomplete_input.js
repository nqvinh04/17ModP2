odoo.define('pragtech_conversations_dashboard/static/src/components/autocomplete_input/autocomplete_input.js', function (require) {
'use strict';

const useShouldUpdateBasedOnProps = require('mail/static/src/component_hooks/use_should_update_based_on_props/use_should_update_based_on_props.js');
const useShouldUpdateBasedOnProps2 = require('mail/static/src/component_hooks/use_should_update_based_on_props/use_should_update_based_on_props.js');
const useUpdate = require('mail/static/src/component_hooks/use_update/use_update.js');

const { Component } = owl;

class AutocompleteInput2 extends Component {
...
Object.assign(AutocompleteInput2, {
    defaultProps: {
    ...
    template: 'mail.AutocompleteInputconversations',
});
