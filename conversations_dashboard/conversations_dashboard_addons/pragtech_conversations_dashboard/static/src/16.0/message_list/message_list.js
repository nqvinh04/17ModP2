...
export class WhatsappMessageList extends Component {
...
Object.assign(WhatsappMessageList, {
    components: { Transition },
    props: { record: Object },
    template: 'whatsapp.MessageList',
});

registerMessagingComponent(WhatsappMessageList);
