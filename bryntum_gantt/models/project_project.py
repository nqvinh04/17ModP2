...
class ProjectProject(models.Model):
    ...
    def get_bryntum_values(self):
        ...
        res = {
            ...
            "bryntum_auto_scheduling": su.get_param('bryntum.auto_scheduling') == 'True',
            "bryntum_user_assignment": su.get_param('bryntum.user_assignment') == 'True',
            "bryntum_readonly_project": su.get_param('bryntum.readonly_projects') == 'True',
